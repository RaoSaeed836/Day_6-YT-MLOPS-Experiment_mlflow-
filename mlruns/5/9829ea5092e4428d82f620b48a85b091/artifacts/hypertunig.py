...
with mlflow.start_run() as parent:
    ...
    # hm data ko manualy log bkr rhy ha mlflow pr phly hmna dekha tha ka autologing ka automaticaly data log ho rha  tha yha h, nanulay datset ko log kr rhy ha
